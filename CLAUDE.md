...
4. Read the generated `src/types/app.ts` and `src/services/livingAppsService.ts`
5. Build UI **directly** with real API calls (LivingAppsService) — **NO mock data!**
6. Call `mcp__dashboard_tools__deploy_to_github`
